...
for (let i = 0; i < userStorage.length; i++) {
  if (!userStorage[i].isActive) {
    ...
    const verticalLayoutButton = document.getElementById(
    ...
    const sortingElements = document.querySelector(
      ".store-list-sorting-elements"
    );
    ...
    window.onload = () => {
      ...
      verticalLayoutButtonIcon.src =
        "./assets/img/white-vertical-sort-icon.svg";
      horizontalLayoutButtonIcon.src =
        "./assets/img/blue-horizontal-sort-icon.svg";
    ...
    dropdownOptions.addEventListener("click", (e) => {
      ...
      if (selectedDropdownOption === "Tous") {
        ...
        if (
          document
            .getElementById("verticalLayoutButton")
            .classList.contains("selected-orientation-button")
        ) {
        ...
        if (
          document
            .getElementById("horizontalLayoutButton")
            .classList.contains("selected-orientation-button")
        ) {
        ...
        filteredStores = stores.filter(
          (store) => store.storeLocation === selectedDropdownOption
        );
    ...
    horizontalLayoutButton.addEventListener("click", () => {
      let selectedDropdownOption = document
      ...
      if (
        selectedDropdownOption === "Tous" ||
        selectedDropdownOption === "Emplacement"
      ) {
        if (document.querySelector(".vertical-cards-list-container")) {
          document.querySelector(".vertical-cards-list-container").remove();
        }
    ...
    document.addEventListener("click", (e) => {
      ...
      while (targetElement) {
        if (
          targetElement.classList.contains("vertical-card-container") ||
          targetElement.classList.contains("horizontal-card-container")
        ) {
